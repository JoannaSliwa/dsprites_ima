...
def get_dataset(dataset_name,
  ...
  if dataset_name == "mnist":
    ...
    train_ds, get_test_ds = make_train_test(get_dsprites_dataset, **kwargs)
  elif dataset_name == "dsprites_o":
    train_ds, get_test_ds = make_train_test(get_dsprites_dataset_o, **kwargs)
  elif dataset_name == "dsprites_on":
    train_ds, get_test_ds = make_train_test(get_dsprites_dataset_on, **kwargs)
  elif dataset_name == "dsprites_om":
    train_ds, get_test_ds = make_train_test(get_dsprites_dataset_om, **kwargs)
  elif dataset_name == "dsprites_onm":
    train_ds, get_test_ds = make_train_test(get_dsprites_dataset_onm, **kwargs)
